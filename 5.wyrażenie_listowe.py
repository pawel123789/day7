...
class TabularData:
    ...
    def __init__(self, column_names):
        ...
        for idx, name in enumerate(column_names):
            ...
            self._columns = {name: idx for idx, name in enumerate(column_names)}   # to ma robić dokładnie to samo co poprzednie trzy linie
    ...
    def __len__(self):
        return len(self._rows)   # kiedy ktoś wywoła na mnie len, to zrób to, co jest w returnie, tak jak wyżej.
...
print(len(tabelka))
print(str(tabelka))
print(tabelka.get_column('name'))
print(tabelka.get_column('age'))